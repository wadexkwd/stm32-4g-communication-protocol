...
class TileDebugMapWindow(QMainWindow):
    """地图瓦片调试窗口"""
    
    def __init__(self):
        super().__init__()
        self.setWindowTitle("地图瓦片调试")
        ...
        # 加载地图
        self.load_tile_debug_map()
    
    def load_tile_debug_map(self):
        """加载地图瓦片调试页面"""
        print("正在加载地图瓦片调试页面...")
        
        # 使用调试版本的 HTML 文件
        current_dir = os.path.dirname(os.path.abspath(__file__))
        html_file = os.path.join(current_dir, "test_map_tile_debug.html")
