...
class RealMapWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Leaflet 地图组件")
    ...
    def load_real_map(self):
        ...
        html_file = os.path.join(current_dir, "test_map_real.html")
    ...
    def check_map_content(self):
        ...
        # 检查 TileLayer 是否成功加载
        self.map_view.page().runJavaScript(
            "map ? map.hasLayer(map._layers[Object.keys(map._layers)[0]]) : false",
    ...
    def show_error(self):
        ...
        <body style="background-color: #ffcccc; padding: 20px;">
            ...
            <p>无法加载 Leaflet 地图页面。</p>
            <p>请检查：</p>
            <ul>
                <li>HTML 文件是否存在</li>
                <li>网络连接是否正常（需要加载 Leaflet 库）</li>
